...
import { teamcityParser as parser, escapeValue } from '../../src/phpunit/problem-matcher';
    ...
    describe('Teamcity Parser', () => {
        ...
        it('parse test_is_not_same testFailed', () => {
            ...
            expect(parser.parse(teamcity)).toEqual({
                ...
                actual: escapeValue.unescape(
                    "Array &0 (|n    |'e|' => |'f|'|n    0 => |'g|'|n    1 => |'h|'|n)"
                ),
                expected: escapeValue.unescape(
                    "Array &0 (|n    |'a|' => |'b|'|n    |'c|' => |'d|'|n)"
                ),
                flowId: 8024,
            });
        });
