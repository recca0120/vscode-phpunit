...
import { pestProject } from '../../tests/utils';
...
describe('Pest TestOutputParser Text', () => {
    ...
    describe('Teamcity Life Cycle', () => {
        it('testSuiteStarted phpunit.xml', () => {
            resultShouldBe(
                `##teamcity[testSuiteStarted name='${pestProject('phpunit.xml')}' locationHint='pest_qn://Example (Tests\\Feature\\Example)' flowId='68573']`,
                {
        ...
        it('testSuiteStarted tests/Fixtures/CollisionTest.php', () => {
            resultShouldBe(
                `##teamcity[testSuiteStarted name='Tests\\Fixtures\\CollisionTest' locationHint='pest_qn://tests/Fixtures/CollisionTest.php' flowId='68573']`,
                {
                    event: TeamcityEvent.testSuiteStarted,
        ...
        it('testStarted tests/Fixtures/CollisionTest.php::error', () => {
            resultShouldBe(
                `##teamcity[testStarted name='error' locationHint='pest_qn://tests/Fixtures/CollisionTest.php::error' flowId='68573']`,
                {
                    event: TeamcityEvent.testStarted,
        ...
        it('testFinish tests/Fixtures/CollisionTest.php::error', () => {
            resultShouldBe(
                `##teamcity[testFailed name='error' message='Exception: error' details='at tests/Fixtures/CollisionTest.php:4' flowId='68573']`,
                undefined,
            );
        ...
        it('testStarted tests/Fixtures/CollisionTest.php::success', () => {
            resultShouldBe(
                `##teamcity[testStarted name='success' locationHint='pest_qn://tests/Fixtures/CollisionTest.php::success' flowId='68573']`,
                {
                    event: TeamcityEvent.testStarted,
        ...
        it('testSuiteFinished tests/Fixtures/CollisionTest.php', () => {
            resultShouldBe(
                `##teamcity[testSuiteFinished name='Tests\\Fixtures\\CollisionTest' flowId='68573']`,
                {
                    event: TeamcityEvent.testSuiteFinished,
                    id: 'tests/Fixtures/CollisionTest.php',
                    name: 'Tests\\Fixtures\\CollisionTest',
        ...
        it('testSuiteStarted tests/Fixtures/DirectoryWithTests/ExampleTest.php', () => {
            resultShouldBe(
                `##teamcity[testSuiteStarted name='Tests\\Fixtures\\DirectoryWithTests\\ExampleTest' locationHint='pest_qn://tests/Fixtures/DirectoryWithTests/ExampleTest.php' flowId='68573']`,
                {
                    event: TeamcityEvent.testSuiteStarted,
        ...
        it('testStarted tests/Fixtures/DirectoryWithTests/ExampleTest.php::it example 1', () => {
            resultShouldBe(
                `##teamcity[testStarted name='it example 1' locationHint='pest_qn://tests/Fixtures/DirectoryWithTests/ExampleTest.php::it example 1' flowId='68573']`,
                {
                    event: TeamcityEvent.testStarted,
        ...
        it('testSuiteFinished tests/Fixtures/DirectoryWithTests/ExampleTest.php', () => {
            resultShouldBe(
                `##teamcity[testSuiteFinished name='Tests\\Fixtures\\DirectoryWithTests\\ExampleTest' flowId='68573']`,
                {
                    event: TeamcityEvent.testSuiteFinished,
                    id: 'tests/Fixtures/DirectoryWithTests/ExampleTest.php',
                    name: 'Tests\\Fixtures\\DirectoryWithTests\\ExampleTest',
        ...
        it('testSuiteStarted tests/Fixtures/ExampleTest.php', () => {
            resultShouldBe(
                `##teamcity[testSuiteStarted name='Tests\\Unit\\ExampleTest' locationHint='pest_qn://tests/Fixtures/ExampleTest.php' flowId='68573']`,
                {
                    event: TeamcityEvent.testSuiteStarted,
        ...
        it('testStarted tests/Fixtures/ExampleTest.php::it example 2', () => {
            resultShouldBe(
                `##teamcity[testStarted name='it example 2' locationHint='pest_qn://tests/Fixtures/ExampleTest.php::it example 2' flowId='68573']`,
                {
                    event: TeamcityEvent.testStarted,
    ...
    it('name has */', () => {
        resultShouldBe(
            `##teamcity[testStarted name='test /** with comment {@*} should do' locationHint='pest_qn://tests/Unit/ExampleTest.php::test /** with comment {@*} should do' flowId='28391']`,
            {
                event: TeamcityEvent.testStarted,
        ...
        resultShouldBe(
            `##teamcity[testFailed name='test /** with comment {@*} should do' message='Failed asserting that true is identical to false.' details='at tests/Unit/ExampleTest.php:196' flowId='28391']`,
            undefined,
        );

        resultShouldBe(
            `##teamcity[testFinished name='test /** with comment {@*} should do' duration='0' flowId='28391']`,
            {
                event: TeamcityEvent.testFailed,
                id: 'tests/Unit/ExampleTest.php::test /** with comment */ should do',
                name: 'test /** with comment {@*} should do',
    ...
    it('with dataset', () => {
        resultShouldBe(
            `##teamcity[testSuiteStarted name='Addition provider' locationHint='pest_qn://Assertions (Recca0120\\VSCode\\Tests\\Assertions)::Addition provider' flowId='53556']`,
            {
                event: TeamcityEvent.testSuiteStarted,
        ...
        resultShouldBe(
            `##teamcity[testFailed name='Addition provider with data set #1' message='Failed asserting that 1 matches expected 2.' details='at tests/AssertionsTest.php:62' type='comparisonFailure' actual='1' expected='2' flowId='53556']`,
            undefined,
        );
    ...
    it('describe with dataset', () => {
        resultShouldBe(
            `##teamcity[testSuiteStarted name='\`abc\` → \`def\` → \`ijk\` → \`lmn\` → it ha' locationHint='pest_qn://tests/Unit/ExampleTest.php::\`abc\` → \`def\` → \`ijk\` → \`lmn\` → it ha' flowId='11847']`,
            {
                event: TeamcityEvent.testSuiteStarted,
        ...
        resultShouldBe(
            `##teamcity[testSuiteFinished name='\`abc\` → \`def\` → \`ijk\` → \`lmn\` → it ha' flowId='11847']`,
            {
                event: TeamcityEvent.testSuiteFinished,
                id: 'tests/Unit/ExampleTest.php::`abc` → `def` → `ijk` → `lmn` → it ha',
                name: '`abc` → `def` → `ijk` → `lmn` → it ha',
    ...
    describe('Pest v2', () => {
        it('testSuiteStarted phpunit.xml and locationHint prefix is file://', () => {
            resultShouldBe(
                `##teamcity[testSuiteStarted name='${pestProject('phpunit.xml')}' locationHint='file://Example (Tests\\Feature\\Example)' flowId='57317']`,
                {
                    event: TeamcityEvent.testSuiteStarted,
                    id: pestProject('phpunit.xml'),
                    name: pestProject('phpunit.xml'),
        ...
        it('testSuiteStarted Test Suite and locationHint prefix is file://', () => {
            resultShouldBe(
                `##teamcity[testSuiteStarted name='Test Suite' locationHint='file://Example (Tests\\Feature\\Example)' flowId='57317']`,
                {
                    event: TeamcityEvent.testSuiteStarted,
                    id: 'Test Suite',
                    name: 'Test Suite',
        ...
        it('pest-v2 tests/Fixtures/CollisionTest.php', () => {
            resultShouldBe(
                `##teamcity[testSuiteStarted name='Tests\\Fixtures\\CollisionTest' locationHint='file://tests/Fixtures/CollisionTest.php' flowId='57317']`,
                {
                    event: TeamcityEvent.testSuiteStarted,
                    id: 'tests/Fixtures/CollisionTest.php',
                    name: 'Tests\\Fixtures\\CollisionTest',
            ...
            resultShouldBe(
                `##teamcity[testStarted name='success' locationHint='pest_qn://tests/Fixtures/CollisionTest.php::success' flowId='57317']`,
                {
                    event: TeamcityEvent.testStarted,
                    id: 'tests/Fixtures/CollisionTest.php::success',
                    name: 'success',
            ...
            resultShouldBe(
                `##teamcity[testSuiteFinished name='Tests\\Fixtures\\CollisionTest' flowId='57317']`,
                {
                    event: TeamcityEvent.testSuiteFinished,
                    id: 'tests/Fixtures/CollisionTest.php',
                    name: 'Tests\\Fixtures\\CollisionTest',
    ...
    describe('Pest v1', () => {
        ...
        it('testStarted without flowId', () => {
            resultShouldBe(
                `##teamcity[testSuiteStarted name='Tests\\Feature\\ExampleTest' locationHint='pest_qn://Tests\\Feature\\ExampleTest' flowId='58024']`,
                {
                    event: TeamcityEvent.testSuiteStarted,
                    id: 'Tests/Feature/ExampleTest',
                    name: 'Tests\\Feature\\ExampleTest',
            ...
            resultShouldBe(
                `##teamcity[testStarted name='test_example' locationHint='php_qn://${pestProject('tests/Feature/ExampleTest.php')}::\\Tests\\Feature\\ExampleTest::test_example']`,
                {
                    event: TeamcityEvent.testStarted,
                    id: 'Example (Tests\\Feature\\Example)::Example',
                    name: 'test_example',
            ...
            resultShouldBe(
                `##teamcity[testFinished name='test_example' duration='1' flowId='58024']`,
                {
                    event: TeamcityEvent.testFinished,
                    id: 'Example (Tests\\Feature\\Example)::Example',
                    name: 'test_example',
            ...
            resultShouldBe(
                `##teamcity[testSuiteFinished name='Tests\\Feature\\ExampleTest' locationHint='pest_qn://Tests\\Feature\\ExampleTest' flowId='58024']`,
                {
                    event: TeamcityEvent.testSuiteFinished,
                    id: 'Tests/Feature/ExampleTest',
                    name: 'Tests\\Feature\\ExampleTest',
        ...
        it('pest-v1 tests/Fixtures/CollisionTest.php', () => {
            resultShouldBe(
                `##teamcity[testSuiteStarted name='Tests\\Fixtures\\CollisionTest' locationHint='pest_qn://${pestProject('tests/Fixtures/CollisionTest.php')}' flowId='12667']`,
                {
                    event: TeamcityEvent.testSuiteStarted,
                    id: 'tests/Fixtures/CollisionTest.php',
                    name: 'Tests\\Fixtures\\CollisionTest',
            ...
            resultShouldBe(
                `##teamcity[testStarted name='error' locationHint='pest_qn://${pestProject('tests/Fixtures/CollisionTest.php')}::error' flowId='12667']`,
                {
                    event: TeamcityEvent.testStarted,
                    id: 'tests/Fixtures/CollisionTest.php::error',
                    name: 'error',
            ...
            resultShouldBe(
                `##teamcity[testStarted name='success' locationHint='pest_qn://${pestProject('tests/Fixtures/CollisionTest.php')}::success' flowId='12667']`,
                {
                    event: TeamcityEvent.testStarted,
                    id: 'tests/Fixtures/CollisionTest.php::success',
                    name: 'success',
            ...
            resultShouldBe(
                `##teamcity[testSuiteFinished name='Tests\\Fixtures\\CollisionTest' locationHint='pest_qn://${pestProject('tests/Fixtures/CollisionTest.php')}' flowId='12667']`,
                {
                    event: TeamcityEvent.testSuiteFinished,
                    id: 'tests/Fixtures/CollisionTest.php',
                    name: 'Tests\\Fixtures\\CollisionTest',
    ...
    it('multi-word class names', () => {
        resultShouldBe(
            `##teamcity[testStarted name='Login screen can be rendered' locationHint='pest_qn://Authentication Page (Tests\\Feature\\AuthenticationPage)::Login screen can be rendered' flowId='72545']`,
            {
                event: TeamcityEvent.testStarted,
        ...
        resultShouldBe(
            `##teamcity[testFinished name='Login screen can be rendered' duration='1' flowId='72545']`,
            {
                event: TeamcityEvent.testFinished,
                id: 'Authentication Page (Tests\\Feature\\AuthenticationPage)::Login screen can be rendered',
                flowId: 72545,
    ...
    it('testFinished without TestStarted', () => {
        resultShouldBe(
            "##teamcity[testFinished name='`before each` → example' duration='12' flowId='97972']",
            undefined,
        );
    });
    ...
    it('PHPUnit without TestStarted', () => {
        ...
        resultShouldBe(
            `##teamcity[testIgnored name='Login screen can be rendered' message='This test was ignored.' details='' flowId='6611']`,
            {
                event: TeamcityEvent.testIgnored,
                flowId: 6611,
        ...
        resultShouldBe(
            `##teamcity[testSuiteFinished name='Tests\\Feature\\AuthenticationTest' flowId='6611']`,
            {},
        );
    });
});
