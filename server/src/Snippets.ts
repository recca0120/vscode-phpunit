...
export const snippetJson: SinppetJson = {
    ...
    assertJsonFileEqualsJsonFile: {
        ...
        body:
            '\\$this->assertJsonFileEqualsJsonFile($${1:expectedFile}, $${2:actualFile});',
        description:
    ...
    assertJsonStringEqualsJsonFile: {
        ...
        body:
            '\\$this->assertJsonStringEqualsJsonFile($${1:expectedFile}, $${2:actualFile});',
        description:
    ...
    assertJsonStringEqualsJsonString: {
        ...
        body:
            '\\$this->assertJsonStringEqualsJsonString($${1:expectedJson}, $${2:actualJson});',
        description:
    ...
    assertStringMatchesFormatFile: {
        ...
        body:
            '\\$this->assertStringMatchesFormatFile($${1:formatFile}, $${1:string});',
        description:
