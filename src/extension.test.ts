    ...
    describe.each(detectPhpUnitStubs())('PHPUnit $name ($phpUnitVersion)', ({
        ...
        it('should run all tests', async () => {
            ...
            const expected = resolveExpected(
                phpUnitVersion,
                [
                    ['12.0.0', { enqueued: 31, started: 27, passed: 16, failed: 9, end: 1 }],
                    ['10.0.0', { enqueued: 31, started: 35, passed: 23, failed: 10, end: 1 }],
                ],
                { enqueued: 31, started: 30, passed: 17, failed: 11, end: 1 },
            );
        ...
        it('should run test by namespace', async () => {
            ...
            const expected = resolveExpected(
                phpUnitVersion,
                [
                    ['12.0.0', { enqueued: 30, started: 26, passed: 16, failed: 8, end: 1 }],
                    ['10.0.0', { enqueued: 30, started: 34, passed: 23, failed: 9, end: 1 }],
                ],
                { enqueued: 30, started: 29, passed: 17, failed: 10, end: 1 },
            );
        ...
        it('should resolve tests', async () => {
            ...
            expect(countItems(ctrl.items)).toEqual(51);
        });
