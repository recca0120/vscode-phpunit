        ...
        describe('PHPUnit activate()', () => {
            ...
            it('should run all tests', async () => {
                ...
                if (semver.gte(PHPUNIT_VERSION, '10.0.0')) {
                    ...
                    expected = { enqueued: 28, started: 28, passed: 15, failed: 11, end: 1 };
                }
            ...
            it('should run test by namespace', async () => {
                ...
                if (semver.gte(PHPUNIT_VERSION, '10.0.0')) {
                    ...
                    expected = { enqueued: 27, started: 32, passed: 21, failed: 9, end: 1 };
                } else {
                    // expected = { enqueued: 27, started: 28, passed: 16, failed: 10, end: 1 };
                    expected = { enqueued: 27, started: 27, passed: 15, failed: 10, end: 1 };
                }
            ...
            it('should run test suite', async () => {
                ...
                expectTestResultCalled(ctrl, { enqueued: 9, started: 11, passed: 5, failed: 4, end: 1 });
            });
